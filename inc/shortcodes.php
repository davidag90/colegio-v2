...
if (! function_exists('mostrar_protocolos')) {
    function mostrar_protocolos()
    {
        ob_start();
        ...
        if ($query->have_posts()):
            ...
            while ($query->have_posts()):
                ...
                echo '<tr>';
                echo '<td>' . $titulo . '</td>';
                echo '<td><a href="' . $link_doc . '" class="link-dark" target="_blank">Descargar</td>';
                echo '</tr>';
            endwhile;
            echo '</tbody>';
            echo '</table>'; //
...
add_shortcode('lista-protocolos', 'mostrar_protocolos');



if (! function_exists('mostrar_historia_consent')) {
    function mostrar_historia_consent()
    {
        ob_start();

        $args = array(
            'post_type' => 'historia-consent',
            'nopaging' => true
        );
        ...
        if ($query->have_posts()):
            ...
            echo '<thead class="table-primary">';
            echo '<tr>';
            echo '<th>Historia Clínica / Consentimiento Informado</th>';
            echo '<th>Enlace</th>';
            echo '</tr>';
            echo '</thead>';
...
add_shortcode('lista-historia_consent', 'mostrar_historia_consent');
    ...
    function mostrar_links_interes()
    {
        ...
        if ($query->have_posts()):
            ...
            while ($query->have_posts()):
                ...
                echo '<a class="btn btn-primary mt-auto ms-auto me-0 link-light" href="' . $link . '" target="_blank">Ver sitio web</a>';
                echo '</div>'; // .card-body
                echo '</div>'; // .card
            endwhile;
...
if (! function_exists('noticias_pacientes')) {
    function noticias_pacientes()
    {
        ob_start();
        ...
        if ($query->have_posts()):
            ...
            while ($query->have_posts()) {
                ...
                echo '<li class="splide__slide">';
                echo '<div class="noticia-pacientes card h-100">';
                echo '<div class="card-img-top-wrap">';
                echo '<a href="' . $permalink . '"><img src="' . $thumbnail . '" class="card-img-top"></a>';
                echo '</div>';
...
add_shortcode('noticias-pacientes', 'noticias_pacientes');
